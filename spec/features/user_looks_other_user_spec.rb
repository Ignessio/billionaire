...
RSpec.feature 'USER looks at other user page', type: :feature do
  ...
  let!(:games) do
    [
      create(:game, user: vasya, current_level: 0, created_at: Time.parse('19.04.2022, 10:00')),
      create(:game, user: masha, current_level: 4, created_at: Time.parse('19.04.2022, 10:00'), finished_at: Time.parse('19.04.2022, 10:10'), prize: 500)
    ]
  end
